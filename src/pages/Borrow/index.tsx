    ...
    <View style={style.container}>
      ...
      <View style={{ position: 'absolute', bottom: 10, width: '100%', borderTopWidth: 0.5, borderColor: '#50a1e3' }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 10 }}>
          <Text style={{ color: 'red' }}>Đi vay: {Utils.numberWithCommas(borrow)} VND</Text>
      ...
      {/* <TouchableOpacity style={{ position: 'absolute', bottom: 10, right: 20 }} onPress={() => props.goToAdd()}>
        <ButtonAdd />
      </TouchableOpacity> */}
